...
def import_graph_data(graph):
    ...
    nodes_data = [
  {
    ...
    "properties": {
      "id": "Eta/Dynaform",
      "名称": "eta/DYNAFORM",
      "描述": "A completely new Graphic User Interface (GUI) package operating on Windows (10 and higher) platform, designed for stamping simulation model generation, input file preparation, and result processing."
    }
  },
  {
    "labels": [
    ...
    "properties": {
      "id": "Geometry Manager",
      "名称": "Geometry Manager",
      "描述": "A module in eta/DYNAFORM used for model generation and input file preparation for stamping simulation."
    }
  },
  {
    "labels": [
    ...
    "properties": {
      "id": "Result",
      "名称": "Result",
      "描述": "A module in eta/DYNAFORM used for processing the stamping simulation results."
    }
  },
  {
    "labels": [
    ...
    "properties": {
      "id": "Ls-Dyna",
      "名称": "LS-DYNA",
      "描述": "The solver that can be executed on either local or remote server systems for stamping simulation."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "菜单栏(Menu Bar)",
      "名称": "菜单栏(MENU BAR)",
      "描述": "eta/DYNAFORM 菜单可以通过鼠标选取，包含多种功能。在每个菜单下，用户可以点击多个图标以激活功能。"
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Projectbsedfdfs",
      "名称": "ProjectBSEDFDFS",
      "描述": "Imports/exports data to/from eta/DYNAFORM. Includes a modified one-step-based unfolding function, spring back, blank development, and nesting function."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Die Face Design",
      "名称": "Die Face Design",
      "描述": "Provides abundant tools for fast die surface design, including the binder and addendum design, local feature modification, and fast evaluation of die face design."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Process_Module",
      "名称": "Process Module",
      "描述": "Supports users to complete the processes from product import to analysis results, including Tube Bending, Pre-forming, Annealing, Hydroforming, Piercing, and Trimming."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Icon_Bar",
      "名称": "ICON BAR",
      "描述": "Selectable Icon-based toolbars are used to access and manage Project functions."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Left_Mouse_Button",
      "名称": "Left Mouse Button",
      "描述": "Used to select the desired function."
    }
  },
  {
    "labels": [
    ...
    "properties": {
      "id": "Middle_Mouse_Button",
      "名称": "Middle Mouse Button",
      "描述": "Used to complete certain operations."
    }
  },
  {
    "labels": [
    ...
    "properties": {
      "id": "Right_Mouse_Button",
      "名称": "Right Mouse Button",
      "描述": "Used to cancel the last operation."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Press_Mmb_And_Move",
      "名称": "Press MMB and Move",
      "描述": "Press MMB and then LMB, hold MMB and move the mouse button."
    }
  },
  {
    "labels": [
    ...
    "properties": {
      "id": "Translationholdmmb",
      "名称": "TranslationHoldMMB",
      "描述": "Hold MMB and move the mouse button."
    }
  },
  {
    "labels": [
    ...
    "properties": {
      "id": "Shift_Mmb",
      "名称": "Shift+MMB",
      "描述": "Shift+MMB and move the mouse."
    }
  },
  {
    "labels": [
    ...
    "properties": {
      "id": "Mmb_Rmb",
      "名称": "MMB+RMB",
      "描述": "MMB+RMB pressed simultaneously."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Scalingctrlmmb",
      "名称": "ScalingCtrlMMB",
      "描述": "Ctrl+MMB used for scaling and mouse movement."
    }
  },
  {
    "labels": [
    ...
    "properties": {
      "id": "Scrollwheel",
      "名称": "Scroll Wheel",
      "描述": "Scroll Wheel used for scaling or other operations."
    }
  },
  {
    "labels": [
    ...
    "properties": {
      "id": "Option_Center",
      "名称": "Option Center",
      "描述": "Switch operation styles such as Dynaform Style, NX, Catia, or SolidWorks styles."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Iges",
      "名称": "IGES",
      "描述": "A geometry data format that can be directly read by eta/DYNAFORM."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Catia V4",
      "名称": "CATIA V4",
      "描述": "A native CAD data file format that can be directly read by eta/DYNAFORM."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Dynaform File Extensions",
      "名称": "DYNAFORM File Extensions",
      "描述": "The protocol for naming files during an eta/DYNAFORM session includes attaching suffixes that specify file types to file names."
    }
  },
  {
    "labels": [
    ...
    "properties": {
      "id": "Dynaform Model Files",
      "名称": "DYNAFORM Model Files",
      "描述": "DYNAFORM model files are saved with the extension *.dfp."
    }
  },
  {
    "labels": [
    ...
    "properties": {
      "id": "Cad Files",
      "名称": "CAD Files",
      "描述": "CAD files can be imported/exported with extensions like *.igs, *.iges."
    }
  },
  {
    "labels": [
    ...
    "properties": {
      "id": "Cae Solver Files",
      "名称": "CAE Solver Files",
      "描述": "CAE Solver files use extensions including LS-DYNA: *.dyn, *.k, *.key, *mod; ACIS: *.sat, *.sab; NASTRAN: *.nas, *.dat, *.bdf."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      ...
      "描述": "In certain functions such as Copy, Delete, etc., eta/DYNAFORM prompts the user to select lines, surfaces elements, nodes, etc. In addition, different entities correspond to different selection boxes."
    }
  },
  {
    "labels": [
    ...
    "properties": {
      "id": "Show_Hide_Buttons",
      "名称": "Show/Hide Buttons",
      "描述": "Click these buttons to show or hide the options for selection. Options include (a) Display, (b) Hide."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Catia_V5_File_Format",
      "名称": "CATIA V5",
      "扩展名": "*.CATPart, *.CATProduct"
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Selection_Box",
      "名称": "Selection Box",
      "描述": "An interface element to show or hide options in the project."
    }
  },
  {
    "labels": [
    ...
    "properties": {
      "id": "Option_Center_Menu",
      "名称": "Option Center Menu",
      "描述": "A menu to manage display settings such as showing or hiding selection boxes."
    }
  },
  {
    "labels": [
    ...
    "properties": {
      "id": "Yes_No_Menu",
      "名称": "Yes/No Menu",
      "描述": "A menu to toggle the state of selection boxes. 'No' hides all, 'Yes' displays all."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Line Selection Dialog",
      "名称": "Line Selection dialog",
      "描述": "The Line Selection dialog is illustrated in the following figure, including the commonly used selection modes such as Pick, Box and so on."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "By_Layer",
      "名称": "BY LAYER",
      "描述": "Click this button to display the Select Curve dialog, and all lines in the selected layer will be selected."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Click_Lmb_To_Select_The_Line",
      "名称": "Click_LMB_to_select_the_line",
      "描述": "Click LMB to select the line."
    }
  },
  {
    "labels": [
    ...
    "properties": {
      "id": "Drag_Lmb_To_Select_Lines_By_Selection_Type",
      "名称": "Drag_LMB_to_select_lines_by_selection_type",
      "描述": "Drag LMB to select the lines by the selection type."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Free_Region",
      "名称": "FREE REGION",
      "描述": "Select all surfaces located inside any region."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "By Layer",
      "名称": "BY LAYER",
      "描述": "Click this button to display the Select Layer dialog, and all surfaces in the selected layer will be selected."
    }
  },
  {
    "labels": [
    ...
    "properties": {
      "id": "By Displayed",
      "名称": "BY DISPLAYED",
      "描述": "Click this button to select all surfaces that are currently displayed."
    }
  },
  {
    "labels": [
    ...
    "properties": {
      "id": "Inside Region",
      "名称": "INSIDE REGION",
      "描述": "Check this option, and the program will select only surfaces inside the selection region."
    }
  },
  {
    "labels": [
    ...
    "properties": {
      "id": "Outside Region",
      "名称": "OUTSIDE REGION",
      "描述": "Check this option, and the program will select only surfaces outside the selection region."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Line_Selection",
      "名称": "Select the elements inside the line, or the elements inside and intersecting with the line"
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Input_Spread_Angle",
      "名称": "Adjust Spread Angle",
      "描述": "The user can input values to adjust the spread angle. If the angle formed by the normal vectors of the selected element and the adjacent element is less than the selected angle, the adjacent element is selected."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Along Edge",
      "名称": "ALONG EDGE",
      "描述": "This option is used to select the boundary nodes, in conjunction with the Stop Angle, and select those nodes on the edge that have a smaller angle with the selected boundary than the stop angle. The following figures illustrate the plate models constituted by the shell nodes. The Stop Angle is set to 91°. When one boundary node is selected, all connected boundary nodes will be selected."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Boundary Node Selection",
      "名称": "Boundary Node Selection",
  ...
  },
  {
    ...
    "properties": {
      "id": "Cross_Part_Boundary",
      "名称": "Cross Part Boundary",
      "描述": "It enables the user to select the nodes of the adjacent part."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Select_Nodes_On_Edge_With_Smaller_Angle",
      "名称": "Select nodes on edge with smaller angle",
  ...
  },
  {
    ...
    "properties": {
      "id": "Select_Nodes_By_Id",
      "名称": "Select nodes by ID",
  ...
  },
  {
    ...
    "properties": {
      "id": "Shading Mode",
      "名称": "Shading mode",
      "描述": "It prepares surface selection data to select coordinates on the surface when the user has never switched to it."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "显示和捕捉网格",
      "名称": "显示和捕捉网格",
      "描述": "当选择这两个选项时，它会在当前工作平面上显示并捕捉网格。"
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Model_Tree_For_Geometry",
      "名称": "MODEL TREE FOR GEOMETRY",
      "描述": "It is used to manage the operation for geometry model. The model tree contains the sub branches: Curve, Surface, and Element."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "On_Off_Control",
      "名称": "ON/OFF CONTROL",
      "描述": "This function is utilized to manage the model tree viewer. The user can click on the button to fold/unfold the tree. Click to fold the model tree. Click to unfold the model tree."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Curve",
      "名称": "CURVE",
      "描述": "This function is utilized to manage the display of all listed curves."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "On/Off Control Geom/Tool Curve",
      "名称": "On/Off Control Geom/Tool Curve"
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Dynaform7.2",
      "名称": "DYNAFORM7.2",
      "描述": "用户可以点击此菜单查看在线帮助文档，获得关于如何使用该软件的帮助，当用户遇到问题时可使用。同时快捷键F1也可以激活此功能。"
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Structural_Overview",
      "名称": "STRUCTURAL_OVERVIEW"
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Tubeforming",
      "名称": "TUBEFORMING",
      "描述": "Crashworthiness, occupant safety, underwater explosion, and sheet metal forming."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Eta/Dynaform 7.1",
      "名称": "eta/DYNAFORM 7.1",
      "描述": "预测压痕和回弹效应，提供技术参数分析和计算，显著简化分析过程。支持Windows 10/11 x64操作系统，包含激光拼焊板和多阶段成形的坯料成形分析。"
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Appendixb Index File Format",
      "名称": "APPENDIXB INDEX FILE FORMAT",
      "描述": "与eta/DYNAFORM 7.1相关联的文件格式。"
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "License Roaming",
      "名称": "License Roaming",
      "描述": "License Roaming is used to enable a floating license to roam to a system that is disconnected to the network. The resulting license can be used for the number of days specified when the license was set to roam, and it can be checked back automatically."
    }
  },
  {
    "labels": [
    ...
    "properties": {
      "id": "Roam",
      "名称": "Roam",
      "描述": "Select the desired products and click the Roam button. The licenses will be roamed on the client (the roaming machine)."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Roam All Button",
      "名称": "Roam All button",
      "描述": "Allows the user to roam all products"
    }
  },
  {
    "labels": [
    ...
    "properties": {
      "id": "Roaming Days",
      "名称": "Roaming Days",
      "描述": "The number of days specified for roaming"
    }
  },
  {
    "labels": [
    ...
    "properties": {
      "id": "Maximum Roaming Days",
      "名称": "Maximum roaming days",
      "描述": "The maximum number of roaming days allowed is 7"
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Return_License",
      "名称": "Return License",
      "描述": "When the license is set to Roam, the license will be checked back automatically at the end of this operation."
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "properties": {
      "id": "Return",
      "名称": "Return",
      "描述": "Button for returning roamed licenses to the license pool on the server"
    }
  },
  {
    "labels": [
    ...
    "properties": {
      "id": "Return All",
      "名称": "Return All",
      "描述": "Button for returning all roamed licenses to the license pool on the server"
    }
  },
  {
    "labels": [
    ...
    "properties": {
      "id": "Roamed License",
      "名称": "roamed license",
      "描述": "A license that can be temporarily used offline until returned to the original license pool on the server"
    }
  },
  {
    "labels": [
    ...
    "properties": {
      "id": "License Pool",
      "名称": "license pool",
      "描述": "A collection of licenses managed by the server"
    }
  },
  {
    "labels": [
  ...
  },
  {
    ...
    "target_id": "Dynaform File Extensions",
    "target_labels": [
      "文件格式"
    ],
    "type": "MENTIONS",
  ...
  },
  {
    ...
    "target_id": "Dynaform Model Files",
    "target_labels": [
      "文件格式"
    ],
    "type": "MENTIONS",
  ...
  },
  {
    ...
    "target_id": "Catia_V4_File_Format",
    "target_labels": [
      "文件格式"
    ],
    "type": "MENTIONS",
  ...
  },
  {
    ...
    "target_id": "Catia_V5_File_Format",
    "target_labels": [
      "文件格式"
    ],
    "type": "MENTIONS",
  ...
  },
  {
    ...
    "target_id": "Inventor_File_Format",
    "target_labels": [
      "文件格式"
    ],
    "type": "MENTIONS",
  ...
  },
  {
    ...
    "target_id": "Parasolid_File_Format",
    "target_labels": [
      "文件格式"
    ],
    "type": "MENTIONS",
  ...
  },
  {
    ...
    "target_id": "Pro_E_Creo_File_Format",
    "target_labels": [
      "文件格式"
    ],
    "type": "MENTIONS",
  ...
  },
  {
    ...
    "target_id": "Solidworks_File_Format",
    "target_labels": [
      "文件格式"
    ],
    "type": "MENTIONS",
  ...
  {
    "source_id": "Option_Center_Menu",
    "source_labels": [
      "用户界面元素"
    ],
    "target_id": "Selection_Box",
    "target_labels": [
      "用户界面元素"
    ],
    "type": "管理",
  ...
  },
  {
    ...
    "target_id": "Line Selection Dialog",
    "target_labels": [
      "用户界面元素"
    ],
    "type": "包含界面元素",
  ...
  },
  {
    ...
    "target_id": "Click_Lmb_To_Select_The_Line",
    "target_labels": [
      "功能_特性"
    ],
    "type": "MENTIONS",
  ...
  },
  {
    ...
    "target_id": "Drag_Lmb_To_Select_Lines_By_Selection_Type",
    "target_labels": [
      "功能_特性"
    ],
    "type": "MENTIONS",
  ...
  {
    "source_id": "Exclude_Option",
    "source_labels": [
      "功能_特性"
    ],
    "target_id": "Input_Spread_Angle",
    "target_labels": [
      "功能_特性"
    ],
    "type": "与_相关",
  ...
  },
  {
    ...
    "target_id": "Boundary Node Selection",
    "target_labels": [
      "功能_特性"
    ],
    "type": "MENTIONS",
  ...
  {
    "source_id": "8f146e565a17ae12ff16df1f34a0092e",
    "source_labels": [
      "Document"
    ],
    "target_id": "Spread",
  ...
  },
  {
    ...
    "target_id": "Select_Nodes_On_Edge_With_Smaller_Angle",
    "target_labels": [
      "功能_特性"
    ],
    "type": "MENTIONS",
  ...
  },
  {
    ...
    "target_id": "Snap_On_Middle_Point",
    "target_labels": [
      "功能_特性"
    ],
    "type": "MENTIONS",
  ...
  {
    "source_id": "Model_Tree",
    "source_labels": [
      "模型树类型"
    ],
    "target_id": "Model_Tree_For_Geometry",
    "target_labels": [
      "模型树类型"
    ],
    "type": "包含模块",
  ...
  },
  {
    ...
    "target_id": "On/Off Control Geom/Tool Curve",
    "target_labels": [
      "功能_特性"
    ],
    "type": "MENTIONS",
  ...
  {
    "source_id": "Appendixb Index File Format",
    "source_labels": [
      "文件格式"
    ],
  ...
  },
  {
    ...
    "target_id": "Appendixb Index File Format",
    "target_labels": [
      "文件格式"
    ],
    "type": "MENTIONS",
  ...
  },
  {
    ...
    "target_id": "Maximum Roaming Days",
    "target_labels": [
      "功能_特性"
    ],
    "type": "MENTIONS",
